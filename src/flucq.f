...
! calculate the polarization energy of jchain in the old configuration ***
         ...
         vo(11) = vo(11) + vflucqjo
         vo(14) = vo(14) + vewaldjo
      end if
...
! accept move
      ...
      vbox(11,ibox)  = vbox(11,ibox) + (vn(11) - vo(11))
