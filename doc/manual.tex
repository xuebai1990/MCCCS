...
(9 values) followed by the H-matrix. This replaces
maximum volume displacement and {\bf boxlx}, {\bf boxly}, 
{\bf boxlz}, respectively.
...
Unit conversions between simulation units and coarse grained units is rather straight forwards. For example, say you want to set up a system in which \\ \indent $r_c = 7 \AA$ \\ \indent {\tt Number of Beads = 500} \\ \indent {\tt coarse grained density = 2} \\ The course grained density is given by 
\begin{equation}
