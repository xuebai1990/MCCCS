...
\noindent{\textbf{hplc:}} Specifies whether the simulation contains HPLC bonded chains.
...
\noindent{\textbf {lmovie\_vrb:}} Controls verboseness of movie file. If false, doesn't print connectivity.
...
\noindent{\textbf {numberDimensionIsIsotropic:}} The number
...
\noindent{\textbf {lhplc\_c:}} If {\textbf{lhplc}} is true, this must be included. This variable
...
\noindent{\textbf {nhplc\_sca, hplc\_sca:}} If {\textbf{lhplc\_c}} is true, these must be included
...
\noindent{\textbf{lrplc:}} NOTE: This variable is no longer used! See {\textbf{lhplc}}.
