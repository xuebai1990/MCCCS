...
speed up the simulation. Currently only does NOT support
MPI. It usually provides speed up for large system size
(e.g. interaction sites greater than 6,000). False by default.
